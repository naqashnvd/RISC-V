...
alias com {
  ...
  vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_master_translator.sv" -work riscv_core_0_avalon_master_translator   
...
alias elab {
  echo "\[exec\] elab"
  vsim -t ps -L work -L work_lib -L rst_controller -L jtag_uart_0_avalon_jtag_slave_translator -L riscv_core_0_avalon_master_translator -L jtag_uart_0 -L riscv_core_0 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneii_ver $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  vsim -novopt -t ps -L work -L work_lib -L rst_controller -L jtag_uart_0_avalon_jtag_slave_translator -L riscv_core_0_avalon_master_translator -L jtag_uart_0 -L riscv_core_0 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneii_ver $TOP_LEVEL_NAME
}
