...
module  fpu_add_sub_altbarrel_shift_ltd
	( 
	aclr,
	clk_en,
	clock,
...
endmodule //fpu_add_sub_altbarrel_shift_ltd
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fpu_add_sub_altbarrel_shift_aeb
	( 
	data,
	distance,
	result) ;
	...
	assign
		...
		sel_w = {distance[4:0]},
		smux_w = {((({26{(sel_w[4] & (~ dir_w[4]))}} & {sbit_w[113:104], pad_w[15:0]}) | ({26{(sel_w[4] & dir_w[4])}} & {pad_w[15:0], sbit_w[129:120]})) | ({26{(~ sel_w[4])}} & sbit_w[129:104])), ((({26{(sel_w[3] & (~ dir_w[3]))}} & {sbit_w[95:78], pad_w[7:0]}) | ({26{(sel_w[3] & dir_w[3])}} & {pad_w[7:0], sbit_w[103:86]})) | ({26{(~ sel_w[3])}} & sbit_w[103:78])), ((({26{(sel_w[2] & (~ dir_w[2]))}} & {sbit_w[73:52], pad_w[3:0]}) | ({26{(sel_w[2] & dir_w[2])}} & {pad_w[3:0], sbit_w[77:56]})) | ({26{(~ sel_w[2])}} & sbit_w[77:52])), ((({26{(sel_w[1] & (~ dir_w[1]))}} & {sbit_w[49:26], pad_w[1:0]}) | ({26{(sel_w[1] & dir_w[1])}} & {pad_w[1:0], sbit_w[51:28]})) | ({26{(~ sel_w[1])}} & sbit_w[51:26])), ((({26{(sel_w[0] & (~ dir_w[0]))}} & {sbit_w[24:0], pad_w[0]}) | ({26{(sel_w[0] & dir_w[0])}} & {pad_w[0], sbit_w[25:1]})) | ({26{(~ sel_w[0])}} & sbit_w[25:0]))};
endmodule //fpu_add_sub_altbarrel_shift_aeb
...
module  fpu_add_sub_altpriority_encoder_6v7
	...
	fpu_add_sub_altpriority_encoder_3v7   altpriority_encoder17
	( 
	.data(data[1:0]),
...
module  fpu_add_sub_altpriority_encoder_bv7
	...
	fpu_add_sub_altpriority_encoder_6v7   altpriority_encoder15
	( 
	.data(data[3:0]),
	.q(wire_altpriority_encoder15_q));
	fpu_add_sub_altpriority_encoder_6e8   altpriority_encoder16
	( 
	.data(data[7:4]),
...
module  fpu_add_sub_altpriority_encoder_r08
	...
	fpu_add_sub_altpriority_encoder_be8   altpriority_encoder10
	( 
	.data(data[15:8]),
	.q(wire_altpriority_encoder10_q),
	.zero(wire_altpriority_encoder10_zero));
	fpu_add_sub_altpriority_encoder_bv7   altpriority_encoder9
	( 
	.data(data[7:0]),
...
module  fpu_add_sub_altpriority_encoder_rf8
	...
	fpu_add_sub_altpriority_encoder_be8   altpriority_encoder19
	( 
	.data(data[7:0]),
	.q(wire_altpriority_encoder19_q),
	.zero(wire_altpriority_encoder19_zero));
	fpu_add_sub_altpriority_encoder_be8   altpriority_encoder20
	( 
	.data(data[15:8]),
...
module  fpu_add_sub_altpriority_encoder_qb6
	...
	fpu_add_sub_altpriority_encoder_r08   altpriority_encoder7
	( 
	.data(data[15:0]),
	.q(wire_altpriority_encoder7_q));
	fpu_add_sub_altpriority_encoder_rf8   altpriority_encoder8
	( 
	.data(data[31:16]),
...
module  fpu_add_sub_altpriority_encoder_qh8
	...
	fpu_add_sub_altpriority_encoder_nh8   altpriority_encoder27
	( 
	.data(data[1:0]),
	.q(wire_altpriority_encoder27_q),
	.zero(wire_altpriority_encoder27_zero));
	fpu_add_sub_altpriority_encoder_nh8   altpriority_encoder28
	( 
	.data(data[3:2]),
...
module  fpu_add_sub_altpriority_encoder_fj8
	...
	fpu_add_sub_altpriority_encoder_vh8   altpriority_encoder24
	( 
	.data(data[15:8]),
...
module  fpu_add_sub_altpriority_encoder_q28
	...
	fpu_add_sub_altpriority_encoder_n28   altpriority_encoder34
	( 
	.data(data[3:2]),
...
module  fpu_add_sub_altpriority_encoder_v28
	...
	fpu_add_sub_altpriority_encoder_qh8   altpriority_encoder31
	( 
	.data(data[3:0]),
	.q(wire_altpriority_encoder31_q),
	.zero(wire_altpriority_encoder31_zero));
	fpu_add_sub_altpriority_encoder_q28   altpriority_encoder32
	( 
	.data(data[7:4]),
...
module  fpu_add_sub_altpriority_encoder_f48
	...
	fpu_add_sub_altpriority_encoder_vh8   altpriority_encoder29
	( 
	.data(data[7:0]),
	.q(wire_altpriority_encoder29_q),
	.zero(wire_altpriority_encoder29_zero));
	fpu_add_sub_altpriority_encoder_v28   altpriority_encoder30
	( 
	.data(data[15:8]),
...
module  fpu_add_sub_altpriority_encoder_e48
	...
	fpu_add_sub_altpriority_encoder_fj8   altpriority_encoder21
	( 
	.data(data[15:0]),
	.q(wire_altpriority_encoder21_q),
	.zero(wire_altpriority_encoder21_zero));
	fpu_add_sub_altpriority_encoder_f48   altpriority_encoder22
	( 
	.data(data[31:16]),
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fpu_add_sub_altfp_add_sub_run
	( 
	aclr,
	add_sub,
	clk_en,
...
`endif
	...
	fpu_add_sub_altbarrel_shift_ltd   lbarrel_shift
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
	...
	fpu_add_sub_altbarrel_shift_aeb   rbarrel_shift
	( 
...
endmodule //fpu_add_sub_altfp_add_sub_run
//VALID FILE
...
module fpu_add_sub (
	...
	fpu_add_sub_altfp_add_sub_run	fpu_add_sub_altfp_add_sub_run_component (
				.aclr (aclr),
				.add_sub (add_sub),
				.clk_en (clk_en),
				.clock (clock),
