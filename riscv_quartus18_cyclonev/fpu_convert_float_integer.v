...
//altfp_convert CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Cyclone V" OPERATION="FLOAT2INT" ROUNDING="TO_NEAREST" WIDTH_DATA=32 WIDTH_EXP_INPUT=8 WIDTH_EXP_OUTPUT=8 WIDTH_INT=32 WIDTH_MAN_INPUT=23 WIDTH_MAN_OUTPUT=23 WIDTH_RESULT=32 aclr clk_en clock dataa nan overflow result underflow
...
module  fpu_convert_float_integer_altbarrel_shift_kof
	( 
	aclr,
	clk_en,
	clock,
...
endmodule //fpu_convert_float_integer_altbarrel_shift_kof

//synthesis_resources = lpm_add_sub 5 lpm_compare 4 reg 284 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fpu_convert_float_integer_altfp_convert_s3q
	( 
	aclr,
	clk_en,
	clock,
...
`endif
	...
	fpu_convert_float_integer_altbarrel_shift_kof   altbarrel_shift6
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
...
endmodule //fpu_convert_float_integer_altfp_convert_s3q
//VALID FILE
...
module fpu_convert_float_integer (
	...
	fpu_convert_float_integer_altfp_convert_s3q	fpu_convert_float_integer_altfp_convert_s3q_component (
				.aclr (aclr),
				.clk_en (clk_en),
				.clock (clock),
				.dataa (dataa),
