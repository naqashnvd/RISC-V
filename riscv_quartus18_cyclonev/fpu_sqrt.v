...
//altfp_sqrt CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Cyclone V" PIPELINE=16 ROUNDING="TO_NEAREST" WIDTH_EXP=8 WIDTH_MAN=23 aclr clk_en clock data nan overflow result zero
//VERSION_BEGIN 18.0 cbx_altfp_sqrt 2018:04:24:18:04:18:SJ cbx_cycloneii 2018:04:24:18:04:18:SJ cbx_lpm_add_sub 2018:04:24:18:04:18:SJ cbx_mgl 2018:04:24:18:08:49:SJ cbx_nadder 2018:04:24:18:04:18:SJ cbx_stratix 2018:04:24:18:04:18:SJ cbx_stratixii 2018:04:24:18:04:18:SJ  VERSION_END
...
module  fpu_sqrt_alt_sqrt_block_ocb
	( 
	aclr,
	clken,
	clock,
...
endmodule //fpu_sqrt_alt_sqrt_block_ocb

//synthesis_resources = lpm_add_sub 27 reg 764 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fpu_sqrt_altfp_sqrt_0cf
	( 
	aclr,
	clk_en,
	clock,
...
`endif
	...
	fpu_sqrt_alt_sqrt_block_ocb   alt_sqrt_block2
	( 
	.aclr(aclr),
	.clken(clk_en),
	.clock(clock),
	...
	assign
		...
		zero = zero_ff;
endmodule //fpu_sqrt_altfp_sqrt_0cf
//VALID FILE
...
module fpu_sqrt (
	...
	fpu_sqrt_altfp_sqrt_0cf	fpu_sqrt_altfp_sqrt_0cf_component (
				.aclr (aclr),
				.clk_en (clk_en),
				.clock (clock),
				.data (data),
