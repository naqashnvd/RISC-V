...
module  fpu_convert_altbarrel_shift_fof
	( 
	aclr,
	clk_en,
	clock,
...
endmodule //fpu_convert_altbarrel_shift_fof
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fpu_convert_altfp_convert_lsn
	( 
	aclr,
	clk_en,
	clock,
...
`endif
	...
	fpu_convert_altbarrel_shift_fof   altbarrel_shift5
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
...
endmodule //fpu_convert_altfp_convert_lsn
//VALID FILE
...
module fpu_convert (
	...
	fpu_convert_altfp_convert_lsn	fpu_convert_altfp_convert_lsn_component (
				.aclr (aclr),
				.clk_en (clk_en),
				.clock (clock),
				.dataa (dataa),
